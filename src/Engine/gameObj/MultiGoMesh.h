...
public:
    ...
    inline GoMeshSet &create_new_json_goMeshSet( multiGoMeshTypeId_t type_ )noexcept{
        //----- id -----//
    ...
    inline const GoMeshSet &apply_a_json_goMeshSet( multiGoMeshTypeId_t type_, size_t randUVal_ )const noexcept{
        //----- id -----//
        size_t              idx {};
