...
public:
    ...
    inline void init( const glm::dvec2 &dpos_ ){
    ...
    //------- set -------//
    inline void set_alti( double alti_ ){ this->alti = alti_; }
    inline void accum_currentDPos( const glm::dvec2 &addDPos_ ){ this->currentDPos += addDPos_; }

    //------- get -------//
    inline const glm::dvec2 &get_currentDPos() const { return this->currentDPos; }
    inline const double &get_alti() const { return this->alti; }
