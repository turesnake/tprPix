...
void BigMan::init_in_autoMod(   GameObj &goRef_,
    ...
    goRef_.RenderUpdate = std::bind( &BigMan::OnRenderUpdate,  _1 );   
    goRef_.LogicUpdate  = std::bind( &BigMan::OnLogicUpdate,   _1 );

    //-------- actionSwitch ---------//
    goRef_.actionSwitch.bind_func( std::bind( &BigMan::OnActionSwitch,  _1, _2 ) );
...
void BigMan::OnRenderUpdate( GameObj &goRef_ ){
    ...
    //            ptr rebind
    //-------------------------------------//
    BigMan_PvtBinary  *pvtBp = BigMan::rebind_ptr( goRef_ );
