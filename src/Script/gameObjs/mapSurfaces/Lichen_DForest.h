 ...
 * ----------------------------
 */
#ifndef TPR_LICHEN_DARK_FOREST_H_
#define TPR_LICHEN_DARK_FOREST_H_
...
public:
    ...
    inline void rebind_ptr( GameObj *_goPtr ){
        tprAssert( _goPtr->species == Lichen_DForest::specId );
        //-- rebind ptr -----
        goPtr = _goPtr;
        pvtBp = (Lichen_DForest_PvtBinary*)goPtr->get_pvtBinaryPtr();
    }
    ...
    Lichen_DForest_PvtBinary  *pvtBp {nullptr}; //- 指向 goPtr->binary 
                            //- 通过这个指针来 简化调用
